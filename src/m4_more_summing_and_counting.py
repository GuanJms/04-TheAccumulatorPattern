...
def run_test_count_cosines_from():
    ...
    # Test 4:
    expected = 2
    answer = count_cosines_from(6, 9, 0.26)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)
    # Test 5:
    expected = 1
    answer = count_cosines_from(7, 9, 0.28)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)
    # Test 6:
    expected = 2
    answer = count_cosines_from(6, 9, 0.24)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 3:
    expected = 0.653210  # This is APPROXIMATELY the correct answer.
