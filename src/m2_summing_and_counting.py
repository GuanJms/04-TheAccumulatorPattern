...
def run_test_sum_more_cosines():
    ...
    # Test 2:
    expected = -.3027280414  # This is APPROXIMATELY the correct answer.
    ...
    # Test 3:
    expected = 1.852234692  # This is APPROXIMATELY the correct answer.
